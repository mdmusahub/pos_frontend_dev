...
const [token,settoken,count,setcount,user,setuser,Base_url_]=data1
  useEffect(() => {
    axios.get(`${Base_url_}/product/getAll`, { headers }).then(r => setProducts(r.data));
    axios.get(`${Base_url_}/productVariant/getAll`, { headers }).then(r => setVariants(r.data));
    axios.get(`${Base_url_}/ProductInventory/getAll`, { headers }).then(r => setInventory(r.data));
    axios.get(`${Base_url_}/discount/getAll`, { headers }).then(r => setDiscountData(r.data));
  }, []);
  ...
  const handleSubmit = e => {
    ...
    axios.post(`${Base_url_}/order/create`, payload)
      .then(() => {
